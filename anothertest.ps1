#Run as Admin
#Set IP before running
#Removes "Test" user
#Run with connectivity

"
#################################################
###         Defender/Firewall Script          ###
#################################################
"
...
$option = Read-Host '
1. Reconfigure Firewall
2. Configure Defender
3. Disable Bluetooth and Wireless
4. Full Student Machine Configuration
 '
...
if ($option -eq 4) {
	...
	Start-Sleep -s 10
		...
		#Copy-Item -Path "D:\Student LT\Program Files (x86)\VMware" -Destination "C:\Program Files (x86)" -Recurse
